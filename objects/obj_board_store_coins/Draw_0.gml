...
var sep = 1;
var text_x = x + ((sprite_get_width(spr_board_store_coins) / 1.5 - ((wsize * 3) + (sep * 2))) / 2);
var text_y = y + sprite_get_height(spr_board_store_coins) / 4.25;
...
if(number >= 10) and (number < 100){
	var text_x = x + ((sprite_get_width(spr_board_store_coins) / 1.2 - ((wsize * 2) + (sep * 1))) / 2);
