...
var sep = 1;
var text_x = x + ((sprite_get_width(spr_board_record) / 2 - ((wsize * 3) + (sep * 2))) / 2);
var text_y = y + sprite_get_height(spr_board_record) / 1.65;
...
if(number >= 10) and (number < 100){
	var text_x = x + ((sprite_get_width(spr_board_record) / 2) - (((wsize * 2) + (sep * 1)) / 2));
